...
// block_num=batch_size * BLOCKS_PER_BEAM_
template<typename T, int BLOCK_SIZE_, int BLOCKS_PER_BEAM_> // BLOCK_SIZE_=128, BLOCKS_PER_BEAM_=8
...
void invokeBatchTopKSampling(void*          workspace,
                             ...
                             const T*       log_probs,
                             int*           ids, // output_ids [max_seq_len, batch_size]
                             int*           sequence_length,
                             bool*          finished,
                             float*         cum_log_probs,
                             float*         output_log_probs,
